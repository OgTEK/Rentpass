...
void main() {
  final Color seedColor = Color(0xFF00E6B3); // Replace with your seed color
...
class MyApp extends StatelessWidget {
  ...
  const MyApp({Key? key, required this.scheme}) : super(key: key);
...
class MainPage extends StatefulWidget {
  ...
  const MainPage({Key? key, required this.scheme}) : super(key: key);
